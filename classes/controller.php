<?php
	...
	include 'tables/check_devices.php';
	include 'tables/check_rooms.php';

	include 'mod/modified_queries.php';
	...
	class Controller{
		...
		public function __construct($hostname, $username, $password, $dbname){
			...
			$this->cd = new Check_devices($hostname, $username, $password, $dbname);
			$this->cr = new Check_rooms($hostname, $username, $password, $dbname);

			$this->mod = new Modified_queries($hostname, $username, $password, $dbname);
		}
